...
export default {
    ...
    theme: {
        extend: {
            ...
            spacing: {
                '6.5': '1.625rem', // Menambahkan nilai kustom untuk w-6.5, h-6.5, p-6.5, dll.
            },
            screens: {
                '2xsm': '375px',
                'xsm': '425px',
            ...
            // MENAMBAHKAN UKURAN FONT KUSTOM DARI TEMPLATE
            fontSize: {
                'title-md': ['36px', '44px'],
                'title-sm': ['30px', '38px'],
                'theme-sm': ['14px', '20px'],
            ...
            // MENAMBAHKAN SHADOW KUSTOM DARI TEMPLATE
            boxShadow: {
                ...
                'slider-navigation': '0px 1px 2px 0px rgba(16, 24, 40, 0.1), 0px 1px 3px 0px rgba(16, 24, 40, 0.1)', // <-- [FIX] TAMBAHKAN BARIS INI
            },
        },
    },
