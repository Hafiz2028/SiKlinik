                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="role_id"
                            ...
                            Akses</label>
                        <div x-data="{ isOptionSelected: '{{ old('role_id') ? 'true' : 'false' }}' }" class="relative z-20 bg-transparent">
                            <select id="role_id" name="role_id" @change="isOptionSelected = true"
                                ...
                                <option value="" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">Pilih
                                    Role</option>
