    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.html" class="lg:hidden">
                <img class="dark:hidden h-8 w-auto" src="{{ asset('images/logo.png') }}" alt="Logo" />
                <img class="hidden dark:block" src="{{ asset('images/logo-dark.png') }}" alt="Logo" />
            </a>
        ...
        <div :class="menuToggle ? 'flex' : 'hidden'"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span
                        class="mr-3 flex h-11 w-11 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800">
                        <svg class="h-7 w-7 fill-current text-gray-500 dark:text-gray-400" width="24" height="24"
